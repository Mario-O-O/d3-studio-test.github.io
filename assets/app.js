...
w.addEventListener('load', (e) =>{
  setTimeout(() => {   
    ...
    svgInner(".ico-casa", '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 18 18" style="enable-background:new 0 0 18 18;" xml:space="preserve"><style type="text/css">.clase-0{fill:#D1D4E6;}.clase-1{fill:#B3B7CC;}</style><g id="casa-grisCla"><path id="Trazado_1986" class="clase-0" d="M10.8,9.8H6.6c-0.5,0-1,0.4-1,1c0,0,0,0,0,0v4.4h6.2v-4.4C11.8,10.3,11.3,9.8,10.8,9.8C10.8,9.8,10.8,9.8,10.8,9.8z"/></g><g id="casa-grisOsc"><g><path id="Trazado_1984" class="clase-1" d="M5.6,16.7c0,0.5,0.4,1,1,1c0,0,0,0,0,0h4.2c0.5,0,1-0.4,1-1c0,0,0,0,0,0v-1.4H5.6L5.6,16.7z"/><path id="Trazado_1985" class="clase-1" d="M16.9,6.1L9.3,0.7c-0.4-0.3-0.9-0.3-1.2,0L0.4,6.1C0.2,6.3,0,6.6,0,7v7.2c0,0.6,0.5,1,1,1h4.5v-4.4c0-0.5,0.4-1,1-1c0,0,0,0,0,0h4.2c0.5,0,1,0.4,1,1c0,0,0,0,0,0v4.4h4.5c0.6,0,1-0.5,1-1V7C17.3,6.6,17.2,6.3,16.9,6.1z"/></g></g></svg>');
